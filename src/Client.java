...
public class Client  implements ActionListener {
    ...
    Client() {
        ...
        frame.add(p1);
        //back icon
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Chatpicture/3.png"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("Chatpicture/luffy.png"));
        ...
        p1.add(profile);
        //video call icon
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("Chatpicture/video.png"));
        ...
        p1.add(video);
        //phone
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("Chatpicture/phone.png"));
        ...
        p1.add(phone);
        //more option
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("Chatpicture/3icon.png"));
